...
public class BaseProductInput extends BaseModel {
    ...
    private List<ChildProductInput> subProductList;

    private Integer totalLogs;

    public BaseProductInput(String REFID, String SKUID, String organisationId, String name, List<ChildProductInput> subProductList, String profitMargin) {
        this.REFID = REFID;
        this.SKUID = SKUID;
        this.name = name;
    ...
    public BaseProductInput(String id, String REFID, String SKUID, String organisationId, String name, List<ChildProductInput> subProductList, String profitMargin) {
        super(id);
        this.REFID = REFID;
        this.SKUID = SKUID;
        this.name = name;
